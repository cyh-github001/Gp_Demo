...
//    prpo.setProperty("user",load.getString("jdbc.user"))
//    prpo.setProperty("password",load.getString("jdbc.password"))
//    result.write.mode("append").jdbc(load.getString("jdbc.url"),load.getString("jdbc.TableName"),prpo)
